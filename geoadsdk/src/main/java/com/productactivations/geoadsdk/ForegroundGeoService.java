...
public class ForegroundGeoService extends Service implements  SdkNotificationResultListener {
...
public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        .setContentText(text)
        .setSmallIcon(R.drawable.weevate_36_36)
        .build();
        startForeground(stopForegroundId, notification);
    ...
    private void doJob(){
        ...
        EasyLogger.toast(getApplicationContext(), "Called dojob foreground");
        String jsonData = "";
        ...
        mFusedLocationClient.requestLocationUpdates(
                mLocationRequest, new LocationCallback(){
                    ...
                    public void onLocationResult(LocationResult locationResult) {
                        ...
                        new ForegroundGeoService.doPostRequest(){

                            @Override
                            public void onPreExecute(){
                                //     Toast.makeText(getApplicationContext(), "About to start ", Toast.LENGTH_LONG).show();

                                EasyLogger.toast(getApplicationContext(), "Requested geofences foreground " + requestCount + "  and continue? " + !stopFlag);
                            }
                            ...
                            public void onPostExecute(String result){
                                ...
                                if(result!=null && result.indexOf("data") > 0 && !stopFlag ){
                                    EasyLogger.toast(getApplicationContext(),  "Result geofences foreground " +result.length());
...
public IBinder onBind(Intent intent) {
    ...
    public void finishJob(){
        ...
        stopService(new Intent(this, ForegroundGeoService.class));

    }


    public void stopService() {
        Intent serviceIntent = new Intent(this, ForegroundGeoService.class);
    ...
    public  ArrayList<Geofence> getGeofences(ActivationsResponse newR){
        ...
        geofencingClient = LocationServices.getGeofencingClient(ForegroundGeoService.this);
